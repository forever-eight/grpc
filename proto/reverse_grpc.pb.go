...
type ReverseClient interface {
	Do(ctx context.Context, in *ReverseRequest, opts ...grpc.CallOption) (*ReverseResponse, error)
}
...
func (c *reverseClient) Do(ctx context.Context, in *ReverseRequest, opts ...grpc.CallOption) (*ReverseResponse, error) {
	out := new(ReverseResponse)
	err := c.cc.Invoke(ctx, "/grpc.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReverseServer interface {
	Do(context.Context, *ReverseRequest) (*ReverseResponse, error)
...
func (UnimplementedReverseServer) Do(context.Context, *ReverseRequest) (*ReverseResponse, error) {
...
func _Reverse_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Reverse/Do",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverseServer).Do(ctx, req.(*ReverseRequest))
	}
